...
### vif analysis ----
    vif_dat <- subset_all %>%
               dplyr::select(concept, ownership, drive, meal, calorie3, slope_calorie, count3, slope_count, dollar3,
                             slope_dollar, calorie_all3, slope_calorie_all, count_all3, slope_count_all, dollar_all3, slope_dollar_all, total, male,
                             white, black, asian, hisp, median_income, capital_income, hsbelow, collegeup, under18, above65, open12, open18, open24)
    
    vif(lm(formula, subset_all))
